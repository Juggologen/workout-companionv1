...
const LOCALES = {
  en: {
    ...
    'cond.notLive': 'Timer coming soon',
    'cond.notLiveHint':
      'The session screen runs sets and ticks, not a clock. Until it does, this plan is for reading off — save it, or print it.',
    'cond.finisherNote': 'The finisher is not carried into the session screen yet.',
