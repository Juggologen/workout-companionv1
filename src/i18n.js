...
const LOCALES = {
  en: {
    ...
    'cond.editTitle': 'Edit block',
    'cond.editNew': 'New block',
    'cond.editBlock': 'Edit this block',
    'cond.addBlock': 'Add a block',
    'cond.saveBlock': 'Save this block',
    'cond.movements': 'Movements',
    'cond.addMovement': 'Add a movement',
    'cond.removeMovement': 'Take this one out',
    'cond.noMovements': 'Nothing in it yet',
    'cond.noMovementsHint': 'Add a movement or two and the rest fills in.',
    'cond.searchMovements': 'Search movements',
    'cond.pickerTitle': 'What goes in',
    'cond.alreadyIn': 'already in',
    'cond.shape': 'Work and rest',
    'cond.rounds': 'How many rounds',
    'cond.less': 'Less',
    'cond.more': 'More',
    ...
    'cond.createOwn': 'Add your own movement',
    'cond.createTitle': 'Something the list is missing',
    'cond.createSave': 'Create and add it',
    'cond.namePlaceholder': 'Sledgehammer swings',
    'cond.measuredIn': 'Counted in',
    'cond.paceQuestion': 'How many {unit} in a minute, going hard?',
    'cond.paceHint':
      'Not a sprint and not a warm-up — the pace you could hold for about ten minutes. Everything else is sized from this one number, so a rough answer is fine and a wrong one shows up as a workout that feels off.',
    'cond.impact': 'Impact',
    'cond.impact.low': 'Low',
    'cond.impact.medium': 'Some',
    'cond.impact.high': 'High',
    'cond.howTo': 'How to do it',
    'cond.howPlaceholder': 'A sentence or two, for when you meet it again in six weeks.',
    'cond.howHint': 'Shows up behind the info button during a session. Optional.',

    'cond.unit.reps': 'reps',
    'cond.unit.calories': 'calories',
    'cond.unit.metres': 'metres',
    'cond.unit.seconds': 'seconds',
